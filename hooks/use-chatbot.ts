...
export const useChatbot = () => {
  ...
  // Direct prompt — returns the AI text without updating the chat message list
  const sendMessageDirect = async (prompt: string): Promise<string> => {
    if (!isAuthenticated || !piAccessToken) throw new Error("Not authenticated");
